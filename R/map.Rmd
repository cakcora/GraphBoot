...
m41 <- m41 + theme_bw()  + labs(fill = "Perc." 
                            ,title = "NSDUH 2015", x="", y="")
m41<-m41 + scale_y_continuous(breaks=c()) + scale_x_continuous(breaks=c()) + theme(panel.border =  element_blank())+theme(text = element_text(size=16))
m41
...
gbData$well<-(gbData$or18*gbData$well)/gbData$or18
gbData$res<-100*gbData$or18/(gbData$well+gbData$or18)
#head(gbData)
...
m42 <- m42 + theme_bw()  + labs(fill = "Perc." 
                            ,title = "GraphBoot 2017", x="", y="")
m42<-m42 + scale_y_continuous(breaks=c()) + scale_x_continuous(breaks=c()) + theme(panel.border =  element_blank())+theme(text = element_text(size=16))
m42
